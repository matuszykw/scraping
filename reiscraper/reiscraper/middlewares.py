...
class ReiscraperSpiderMiddleware:
...
class ReiscraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScrapeOpsFakeUserAgent:
    ...
    def process_request(self, request, spider):        
        ...
        print("************ NEW FAKE USER AGENT ************")
        print(request.headers['User-Agent'])


class ScrapeOpsFakeBrowserHeader:
